...
\begin{itemize}
	\item [\textbf{2026}] FSU; International Conference on Game Theory (Stony Brook); UC Riverside (scheduled); WATE Conference (FSU, scheduled); ASU Theory Conference (scheduled)
	\item [\textbf{2025}] SKKU; WATE Conference (UF); Theory@Chapel Hill
